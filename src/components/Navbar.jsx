        ...
        <div className="flex xl:gap-8 lg:gap-6">
          {!auth.currentUser ? (
            ...
            <button
              ...
              className="py-[14px] absolute z-50 xl:top-4 xl:right-24 lg:right-20 lg:top-3 px-8 border bg-Green-gradient border-[#07091E] rounded-[50px] text-white font-poppins font-medium text-base leading-6"
            >
              Log out
            </button>
          )}
